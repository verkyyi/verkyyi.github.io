...
## System Health (last watcher: 2026-03-27T16:53Z)
- Self-Evolve: healthy (last success 16:19Z 03-27)
- Deploy: SKIP in config (workflow_dispatch-only)
- pages-build-deployment: healthy (last success 16:22Z 03-27)
...
- Token utilization: 257 data points, 3 model fallbacks (1.2%, isolated), 0 max-turns hits, 0 rate-limit errors
