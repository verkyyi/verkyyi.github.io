...
## System Health (last watcher: 2026-03-28T12:49Z)
- Self-Evolve: healthy (last success 12:12Z 03-28)
- Deploy: SKIP in config (workflow_dispatch-only)
- pages-build-deployment: healthy (last success 12:15Z 03-28)
...
- Token utilization: 299 data points, all claude-opus-4-6 (recent), 0 max-turns hits, 0 rate-limit errors
...
## Open PRs
- #27 Reduce evolve.yml and watcher.yml cron to every 3 hours — needs-review (created 12:18Z 03-28, 0 reviews, 30min old)
