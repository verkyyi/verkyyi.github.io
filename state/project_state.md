...
- Pipeline Watcher: healthy (03:44Z 04-16, this run). 10/10 recent successes.
...
- Haiku fallback: 104 runs (~53h since 04-13T22:19Z). Current run reports Opus — streak may end. P1 monitoring.
