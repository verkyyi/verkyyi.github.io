...
<!-- Last updated: 2026-04-11T06:28Z (week 29 analysis) -->
...
| Recurring log truncation | — | — | proposed | 2026-04-10 | Truncated W28 and W29. Agent_log regrew past limit in 12h. Need watcher entry compression. |
| Watcher all-clear compression | — | — | proposed | 2026-04-11 | .proposed-change.md written. 682-byte entries → ~80 bytes. Would reduce agent_log growth ~87%. |
...
| Phantom PR pattern | 4 | 7 phantom PRs (#54, #55, #56, #59, #60, #61 + prior) | Circular: proposals to fix the pattern also phantom-merge. Only coder direct edits via issues work. |

## Completed
| Feature | Issue | PR | Completed |
|---------|-------|-----|-----------|
| Log re-truncation (W29 analysis) | — | — | 2026-04-11 (agent_log 154→54KB, research_log 36→22KB. Regrew past limit in 12h — verbose watcher entries.) |
